...
Чтобы добавить фото, просто отправьте его в чат одним из способов:
🔹 <b>Как файл</b> — нажмите на значок 📎 (скрепка) в чате и выберите «Файл», затем укажите изображение с вашего устройства. Это <b>предпочтительный способ</b> — так мы получаем фото в исходном качестве без сжатия.

⚠️ <b>Важно!</b> Не отправляйте фото как обычное изображение (через галерею) — Telegram сильно сжимает такие файлы, и качество печати может пострадать.
